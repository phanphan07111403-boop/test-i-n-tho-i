...
| `morgana-dh-orb-sim/` | Morgana DH mid (Wild Rift 7.2e) | Does Dark Harvest fit Blackfire → Infinity Orb → Cap vs Liandry+Rylai? |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 morgana-dh-orb-sim/simulate_morgana_dh_orb.py
```
