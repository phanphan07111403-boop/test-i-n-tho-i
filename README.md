...
| `senna-enchanter-sim/` | Enchanter Senna (Wild Rift 7.3) | Helia / Whisper / Ardent / Harmonic — gold-efficient buff order on Q-max Senna |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 senna-enchanter-sim/simulate_senna_buff.py
```
