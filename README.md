...
| `viktor-pen-vs-burn-sim/` | Viktor mid (Wild Rift 7.2e) | Luden+Infinity Orb vs Blackfire+Liandry: poke vs 5.5s R all-in, squishy vs tank |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 viktor-pen-vs-burn-sim/simulate_viktor.py
```
