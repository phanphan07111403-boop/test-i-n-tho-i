...
| `smolder-late-sim/` | Smolder ADC (Wild Rift 7.3) | Strongest late page after Magnetic Blaster died and IE became the Q-crit capstone |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 smolder-late-sim/simulate_smolder_late.py
```
