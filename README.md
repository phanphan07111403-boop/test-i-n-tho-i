...
| `senna-73-sim/` | Senna ADC + support (Wild Rift 7.3) | Magnetic gone, mist crit 10%/20: Youmuu→Collector→Hex ADC; support Shiv→ER shove, Hex 2nd for AA-Q-AA burst |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 senna-73-sim/simulate_senna_73.py
```
