...
| `braum-support-sim/` | Braum support (Wild Rift 7.2+) | Skip Yordle Trap (R-only displace); which peel path actually saves the ADC? |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 braum-support-sim/simulate_braum_support.py
```
