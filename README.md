...
| `senna-boots-sim/` | Senna ADC + support (Wild Rift 7.3) | Ionian vs Boots of Dynamism once leftover Long Sword, Q refunds, and Flash haste are modeled |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 senna-boots-sim/simulate_senna_boots.py
```
