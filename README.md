...
| `sion-heartsteel-target/` | Sion (Wild Rift Heartsteel) | Is there an attack mode that prefers Heartsteel-ready champions? |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 sion-heartsteel-target/simulate_heartsteel_target.py
```
