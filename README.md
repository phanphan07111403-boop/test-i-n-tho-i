...
| `gamesir-cloned-mode/` | GameSir World mapping | How to turn on, retarget, and turn off **Cloned Mode** (two HUD spots at once) |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 gamesir-cloned-mode/diagnose.py
```
