...
| `morgana-mid-boots-sim/` | Morgana mid (Wild Rift 7.2e) | Ionian vs Boots of Mana once mid farm (CS / Big Bully / W mana) is modeled |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 morgana-mid-boots-sim/simulate_morgana_boots.py
```
