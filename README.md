...
| `sona-buff-sim/` | Sona support (Wild Rift 7.3) | Helia / Whispering Circlet / Ardent / Harmonic — which order is most gold-efficient for buffs + fight impact? |

```bash
python3 zyra-burn-sim/simulate_zyra_burn.py
python3 ap-kogmaw-sim/simulate_ap_kogmaw.py
python3 sona-buff-sim/simulate_sona_buff.py
```
